...
enum class OnionskinType : std::uint8_t
{
  NONE,
  MERGE,
  RED_BLUE_TINT,
...
public:
  ...
  [[nodiscard]] OnionskinType type() const { return m_type; }
  [[nodiscard]] OnionskinPosition position() const { return m_position; }
  [[nodiscard]] int prevFrames() const { return m_prevFrames; }
  [[nodiscard]] int nextFrames() const { return m_nextFrames; }
  [[nodiscard]] int opacityBase() const { return m_opacityBase; }
  [[nodiscard]] int opacityStep() const { return m_opacityStep; }
  [[nodiscard]] FrameTag* loopTag() const { return m_loopTag; }
  [[nodiscard]] Layer* layer() const { return m_layer; }
...
private:
  ...
  OnionskinPosition m_position = OnionskinPosition::BEHIND;
  int m_prevFrames = 0;
  int m_nextFrames = 0;
  int m_opacityBase = 0;
  int m_opacityStep = 0;
  FrameTag* m_loopTag = nullptr;
