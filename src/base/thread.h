...
private:
  ...
  template <class Callable> class func_wrapper0 : public func_wrapper
  {
  public:
    Callable f;
    func_wrapper0(const Callable& f)
      : f(f)
    {
    }
  ...
  template <class Callable, class A> class func_wrapper1 : public func_wrapper
  {
  public:
    Callable f;
    A a;
    func_wrapper1(const Callable& f, A a)
      : f(f)
      , a(a)
    {
    }
  ...
  public:
    ...
    A a;
    B b;
    func_wrapper2(const Callable& f, A a, B b)
      : f(f)
      , a(a)
      , b(b)
    {
    }
    void operator()() override { f(a, b); }
  };
};
