...
// BindAdapter0_fun
template <typename R, typename F> class BindAdapter0_fun
{
  F f;

public:
  BindAdapter0_fun(const F& f)
    : f(f)
  {
  }
  ...
  R operator()(const A1& a1, const A2& a2, const A3& a3, const A4& a4) const
  {
    return f();
  }
};

template <typename F> class BindAdapter0_fun<void, F>
{
  F f;
...
template <typename R, typename F> BindAdapter0_fun<R, F> Bind(const F& f)
{
  return BindAdapter0_fun<R, F>(f);
}

// BindAdapter0_mem
template <typename R, typename T> class BindAdapter0_mem
{
  R (T::*m)();
  T* t;
...
template <typename T> class BindAdapter0_mem<void, T>
{
  void (T::*m)();
  T* t;
...
// BindAdapter1_fun
template <typename R, typename F, typename X1> class BindAdapter1_fun
{
  F f;
  X1 x1;
...
template <typename F, typename X1> class BindAdapter1_fun<void, F, X1>
{
  F f;
  X1 x1;
...
public:
  template <typename T2>
  BindAdapter1_mem(void (T::*m)(B1), T2* t, X1 x1)
    : m(m)
    , t(t)
    , x1(x1)
  {
...
public:
  template <typename T2>
  BindAdapter2_mem(R (T::*m)(B1, B2), T2* t, X1 x1, X2 x2)
    : m(m)
    , t(t)
    , x1(x1)
    , x2(x2)
...
template <typename T, typename B1, typename B2, typename X1, typename X2>
...
public:
  template <typename T2>
  BindAdapter2_mem(void (T::*m)(B1, B2), T2* t, X1 x1, X2 x2)
    : m(m)
    , t(t)
    , x1(x1)
    , x2(x2)
...
public:
  BindAdapter3_fun(const F& f, X1 x1, X2 x2, X3 x3)
    : f(f)
    , x1(x1)
    , x2(x2)
    , x3(x3)
...
template <typename R, typename F, typename X1, typename X2, typename X3>
BindAdapter3_fun<R, F, X1, X2, X3> Bind(const F& f, X1 x1, X2 x2, X3 x3)
{
...
public:
  template <typename T2>
  BindAdapter3_mem(void (T::*m)(B1, B2, B3), T2* t, X1 x1, X2 x2, X3 x3)
    : m(m)
    , t(t)
    , x1(x1)
    , x2(x2)
...
public:
  BindAdapter4_fun(const F& f, X1 x1, X2 x2, X3 x3, X4 x4)
    : f(f)
    , x1(x1)
    , x2(x2)
    , x3(x3)
...
template <class T> RefWrapper<T> Ref(T& ref)
{
