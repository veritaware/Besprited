...
public:
  ...
  ~SetClip() { m_graphics->setClipBounds(m_oldClip); }
...
public:
  ...
  ~IntersectClip() { m_graphics->setClipBounds(m_oldClip); }
...
public:
  ...
  ~CheckedDrawMode() { m_graphics->setDrawMode(Graphics::DrawMode::Solid); }
...
using GraphicsPtr = base::SharedPtr<Graphics>;
