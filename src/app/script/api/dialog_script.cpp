...
public:
  DialogExtension()
  {
    ...
    cls.addGetter("canClose") = [](DialogObject&) -> JSON::Value
    { return true; };
    ...
    cls.addMethod("addLabel") = [](DialogObject& self, const std::string& text,
                                   const std::string& id) -> JSON::Value
    { return widgetToNative(self.addLabel(text, id)); };
    // addButton(text, id) -> the Button object.
    cls.addMethod("addButton") = [](DialogObject& self, const std::string& text,
                                    const std::string& id) -> JSON::Value
    ...
    cls.addMethod("addEntry") = [](DialogObject& self, const std::string& text,
                                   const std::string& id) -> JSON::Value
    ...
    cls.addMethod("addIntEntry") =
        [](DialogObject& self, const std::string& text, const std::string& id,
           int min, int max) -> JSON::Value
    { return widgetToNative(self.addIntEntry(text, id, min, max)); };
    // addImageView(id) -> the ImageView object.
    cls.addMethod("addImageView") = [](DialogObject& self,
                                       const std::string& id) -> JSON::Value
    { return widgetToNative(self.addImageView(id)); };
    // addPaletteListBox(id) -> the PaletteListBox object.
    cls.addMethod("addPaletteListBox") =
        [](DialogObject& self, const std::string& id) -> JSON::Value
    ...
    cls.addMethod("get") = [](DialogObject& self,
                              const std::string& id) -> JSON::Value
