...
{
public:
  Diagonal45Symmetry(int x, int y)
    : m_x(x)
    , m_y(y)
  {
  }
...
{
public:
  Diagonal135Symmetry(int x, int y)
    : m_x(x)
    , m_y(y)
  {
  }
...
{
public:
  Rotational180Symmetry(int x, int y)
    : m_x(x)
    , m_y(y)
  {
  }
...
{
public:
  Rotational90Symmetry(int x, int y)
    : m_x(x)
    , m_y(y)
  {
  }
...
{
public:
  CompositeSymmetry(int flags, int x, int y)
    : m_flags(flags)
    , m_x(x)
    , m_y(y)
  {
