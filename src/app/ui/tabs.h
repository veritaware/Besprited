...
public:
  ...
  // When the tab close button is pressed (or middle mouse button is used to
  // close it).
             ...
             public AnimatedWidget
{
  ...
  using TabPtr = base::SharedPtr<Tab>;

  using TabsList = std::vector<TabPtr>;
  using TabsListIterator = TabsList::iterator;
