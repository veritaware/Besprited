...
{
public:
  ScopedWebPPicture(WebPPicture& pic)
    : m_pic(pic)
  {
  }
  ~ScopedWebPPicture() { WebPPictureFree(&m_pic); }
...
const char* getEncoderErrorMessage(WebPEncodingError errorCode)
{
  ...
  case VP8_ENC_ERROR_NULL_PARAMETER:
    return "a pointer parameter is nullptr";
    break;
...
bool WebPFormat::onSave(FileOp* fop)
{
  ...
  base::SharedPtr<WebPOptions> webp_options = fop->sequenceGetFormatOptions();
