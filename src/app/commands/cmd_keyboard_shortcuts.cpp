...
private:
  ...
  bool onProcessMessage(Message* msg) override
  {
    ...
    case kMouseMoveMessage:
    {
      ...
      const Accelerators* accels = (m_key ? &m_key->accels() : nullptr);
      int y = bounds.y;
...
KeyboardShortcutsCommand::KeyboardShortcutsCommand()
  : Command("KeyboardShortcuts", "Keyboard Shortcuts", CmdUIOnlyFlag)
{
}
...
void KeyboardShortcutsCommand::onExecute(Context* context)
{
  ...
  // TODO Seeing this, we need a complete new way to handle UI commands
  // execution
