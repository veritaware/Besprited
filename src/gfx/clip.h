...
public:
  ...
  [[nodiscard]] Rect dstBounds() const { return {dst, size}; }
  [[nodiscard]] Rect srcBounds() const { return {src, size}; }
  ...
  bool clip(
      // Available area
      int avail_dst_w, int avail_dst_h, int avail_src_w, int avail_src_h);
};
