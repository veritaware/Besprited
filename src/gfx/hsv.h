...
public:
  ...
  [[nodiscard]] double hue() const { return m_hue; }

  // Returns color's saturation, a value from 0 to 100
  [[nodiscard]] double saturation() const { return m_saturation; }
  ...
  [[nodiscard]] int hueInt() const;
  [[nodiscard]] int saturationInt() const;
