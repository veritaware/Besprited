...
class UI {
    ...
    export(){
        ...
        // app.launch() only opens http(s) URLs (see issue #219) - it can no
        // longer be used to open a locally-saved file in an external
        // viewer, so just show the path for the user to open manually.
