...
#define MyAppURL "https://github.com/Veritaware/Besprited"
...
OutputDir=.
OutputBaseFilename=BespritedInstaller
...
Source: "..\build\bin\besprited.exe"; DestDir: "{app}"; Flags: ignoreversion
